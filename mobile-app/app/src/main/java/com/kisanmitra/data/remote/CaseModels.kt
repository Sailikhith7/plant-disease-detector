...
data class ExpertDeskCaseDto(
    ...
    @SerializedName("pest") val pest: String? = null,
    @SerializedName("pest_confidence") val pestConfidence: Int? = 0,
    @SerializedName("pest_status") val pestStatus: String? = null,
...
data class CaseResponse(
    ...
    @SerializedName("pest") val pest: String? = null,
    @SerializedName("pest_confidence") val pestConfidence: Float? = null,
    @SerializedName("pest_status") val pestStatus: String? = null,
    @SerializedName("status") val status: String = "",
